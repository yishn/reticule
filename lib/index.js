...
exports.buildReticule = function(dirname) {
    var __, execPath, template, bookinfo, renderer, macros, toc, linear, alltags, items, keywords, i1, l1, item, nav, renderedtoc;
    __ = function(x1) {
        return (r = localization).get.call(r, dirname, x1);
    };
    /*@206:5*/
