(function() {
var fs, path, diacritic, marked, milk, uglify, cssshrink, renderers, ReticuleRenderer, TocRenderer, LinearTocRenderer, cache, readdirRecursive, fillTemplate, loadFile, r;
sign = function(x) {
...
loadFile = compose(function(x1) {
    ...
    return (r = path).join.call(r, x1, x2);
}, null, null);
/*@36:1*/
