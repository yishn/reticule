(function() {
var fs, path, diacritic, marked, milk, uglify, cssshrink, renderers, ReticuleRenderer, TocRenderer, GetLinksRenderer, cache, readdirRecursive, fillTemplate, r, r1;
sign = function(x) {
...
GetLinksRenderer = renderers.GetLinksRenderer;
/*@16:1*/
cache = {};
...
exports.getLinearToc = function(toc) {
    var renderer;
    renderer = new GetLinksRenderer();
    marked(toc, {
        renderer: renderer
    });
    /*@41:5*/
    return renderer.links.map(function() {
        var href, title, text;
        (function(r) {
            (function(r1) {
                href = r1.href;
...
/*@43:1*/
exports.renderToc = function(toc, dirname, sectionpath) {
    return marked(toc, {
        renderer: new TocRenderer(dirname, sectionpath)
    });
};
/*@46:1*/
...
exports.renderLinearNav = function() {
    ...
    output = '<p class="nav">\n';
    if (prev != null) {
        output += (((('<a href="' + path.join(relative, prev.path, 'index.html')) + '" class="prev">&laquo; ') + prev.title) + '</a>\n');
    };
    /*@176:5*/
    if (next != null) {
        output += (((('<a href="' + path.join(relative, next.path, 'index.html')) + '" class="next">') + next.title) + ' &raquo;</a>\n');
    };
    return output + '</p>';
};
/*@182:1*/
