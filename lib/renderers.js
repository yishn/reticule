(function() {
var path, reticule, Renderer, ReticuleRenderer, TocRenderer, GetLinksRenderer;
extend = function(x, y) {
    var copy = function() {};
...
TocRenderer = (function() {
    ...
    init.prototype.link = function(href, title, text) {
        ...
        self = this;
        /*@70:9*/
        out = ((('<a href="' + path.join(self.relative, href, 'index.html')) + '" data-path="') + path.join(href, 'index.html')) + '"';
...
GetLinksRenderer = (function() {
    ...
    init.prototype.link = function(href, title, text) {
        ...
        /*@86:9*/
        return self.__super__.link.call(self, href, title, text);
    };
    return init;
})();
...
exports.GetLinksRenderer = GetLinksRenderer;
})();
